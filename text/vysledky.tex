...
% \includegraphics[width=\textwidth]{c_dakel_ae_compute.png}
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.75\linewidth]{obrazky/c_dakel_ae_compute.png}
    \caption{Třída pro~práci s~binárním souborem dle~zadané cesty 
    a~pro~následný výpočet zadaných parametrů (ASL, RMS, výkon)}
    \label{fig:dakel_class}
\end{figure}
...
Program od firmy Vallen se jmenuje VisualClass. Umí rozeznat podobnosti 
a~rozdíly mezi změřenými průběhy AE.
Jak je z názvu přímo patrné, umí tato data klasifikovat~–~každé vlně přidělí určité číslo třídy. V každé z těchto přidělených tříd klasifikuje podobnost se vzorovými 
daty. 
Funkcí, která představuje míru podobnosti mezi vlastní 
změřenou vlnou a vzorem, je poměr vzdáleností. 
...
Klasifikované výsledky lze tak i statisticky zpracovat.

...
\section{Vývoj modelů strojového učení pro lokalizaci zdrojů AE}
Jak již bylo výše uvedeno, použití neuronových sítí pro lokalizaci zdrojů
AE podstatně komplikuje nutnost lidské expertízy a nelze tak proces
řízeného učení efektivně automatizovat. V současné době je tak
snaha o vývoj algoritmů clusteringu z velkým výpočetním výkonem.
\section{Experiment}

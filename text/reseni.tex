...
\begin{figure}[htbp]
    ...
    \caption{Příklad okna v software NOESIS \cite{Noesis}}
...
energii signálu (aJ), a další uvedené v \cite{Noesis}. Z těchto příznaků umí stanovit diskriminant, nebo také určí diskriminant celé třídy.
...
\begin{figure}[htbp]
    ...
    \caption{Příklad dendrogramu v software NOESIS \cite{Noesis}}
